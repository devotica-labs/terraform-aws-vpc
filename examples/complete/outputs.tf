...
output "interface_endpoint_ids" { value = module.vpc.interface_endpoint_ids }
output "interface_endpoints_security_group_id" { value = module.vpc.interface_endpoints_security_group_id }
